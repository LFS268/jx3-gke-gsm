...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
	      <td><a href='' title='A Helm chart for Kubernetes'> <img src='https://raw.githubusercontent.com/cdfoundation/artwork/master/jenkinsx/icon/color/jenkinsx-icon-color.png' width='24px' height='24px'> lfs268-pipeline-lab </a></td>
	      <td>0.0.2</td>
	      <td></td>
	      <td></td>
	    </tr>
